...
For instance, a new feature and its documentation are **two separated commits**, even if it's a single line comment.  
**Commit often.**
...
#### :books: Pull requests
Before openning a pull request you must verify that;
- your branch is fully working with no bug.
- master as been merged on your branch, and tested.
- you've reviewed your code.
